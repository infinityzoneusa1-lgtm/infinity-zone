      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Join thousands of successful content creators who are already earning 
            with our platform. Start creating amazing content today!
          </p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-8">
            ...
            <p className="text-gray-300 mb-6">
              Be the first to know about new opportunities and exclusive creator events.
            </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button variant="outline" className="border-white text-white hover:bg-white hover:text-purple-900 px-8 py-4 rounded-full text-lg">
              Learn More
            </Button>
          </div>
          ...
          <div className="mt-6">
            <p className="text-sm text-gray-300">
              ...
              <Link href="/terms-and-conditions" className="text-pink-400 hover:text-pink-300 underline">
                Terms and Conditions
              </Link>
              {" "}and{" "}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12 text-center">
            <div>
              <div className="text-2xl md:text-3xl font-bold text-pink-400 mb-1">98%</div>
              <div className="text-sm text-gray-300">Satisfaction Rate</div>
            </div>
            <div>
              <div className="text-2xl md:text-3xl font-bold text-purple-400 mb-1">24h</div>
              <div className="text-sm text-gray-300">Approval Time</div>
            </div>
            <div>
              <div className="text-2xl md:text-3xl font-bold text-pink-400 mb-1">$2K+</div>
