  ...
  return (
    <section className="py-8 md:py-16 bg-gray-200">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl md:text-4xl font-bold text-center text-red-900 mb-8 md:mb-12">PROFESSIONALS</h2>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 max-w-6xl mx-auto">
          {professionals.map((professional, index) => (
            <Card key={index} className="bg-white rounded-2xl md:rounded-3xl shadow-lg overflow-hidden">
              <CardContent className="p-0">
                <div className="flex flex-col sm:flex-row items-center">
                  ...
                  <div className="flex-1 p-4 md:p-8 text-center sm:text-left sm:order-1">
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-1">{professional.name}</h3>
                    <p className="text-gray-600 text-xs md:text-sm mb-4 md:mb-6">{professional.title}</p>
                    <Button 
