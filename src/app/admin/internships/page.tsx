...
export default function AdminInternships() {
  ...
  const openApplicationModal = (application: InternshipApplication) => {
          ...
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="text-gray-600">
                Review and manage internship program applications
              </p>
            </div>
                      ...
                      <td className="px-6 py-4">
                        <div className="text-sm text-gray-900">
                          ...
                          <div className="text-gray-500 text-xs mt-1">
                            {application.state}, {application.postalCode}
                          </div>
                        </div>
                      </td>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-500">
                  Applications received for internship program
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mt-3">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">
                    {selectedApplication.applyingFor}
                  </p>
                </div>
