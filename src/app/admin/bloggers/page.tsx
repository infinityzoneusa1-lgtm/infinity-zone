...
export default function AdminBloggers() {
  ...
  const [selectedApplication, setSelectedApplication] =
    useState<BloggerApplication | null>(null);
  ...
  const deleteApplication = async (id: string) => {
    if (
      window.confirm(
        "Are you sure you want to delete this blogger application?"
      )
    ) {
      try {
        const response = await fetch(
  ...
  const openApplicationModal = (application: BloggerApplication) => {
          ...
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="text-gray-600">
                Review and manage blogger applications
              </p>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h3 className="text-lg font-medium text-gray-900">
                  Total Blogger Applications
                </h3>
                <p className="text-2xl font-bold text-green-600">
                  {applications.length}
                </p>
                <p className="text-sm text-gray-500">
                  Applications received from aspiring bloggers
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-gray-900">
                      {selectedApplication.blogCategory}
                    </p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">
